...
export default { example: figma.code`<Card asset={${instance.getBoolean('Asset')}} assetType="${instance.getEnum('Asset Type', { Icon: 'Icon', Image: 'Image' })}" body="${instance.getString('Body')}" direction="${instance.getEnum('Direction', { Horizontal: 'Horizontal', Vertical: 'Vertical' })}" heading="${instance.getString('Heading')}" variant="${instance.getEnum('Variant', { Stroke: 'Stroke', Default: 'Default' })}" />`, imports: ['import { Card } from "./src/components/Card"'], id: 'card' };