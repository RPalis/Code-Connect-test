...
export default { example: figma.code`<RadioField description="${instance.getString('Description')}" hasDescription={${instance.getBoolean('Has Description')}} label="${instance.getString('Label')}" state="${instance.getEnum('State', { Default: 'Default', Disabled: 'Disabled' })}" valueType={${instance.getBoolean('Value Type')}} />`, imports: ['import { RadioField } from "./src/components/InputControls"'], id: 'radio-field' };